...
bot_token = os.environ.get("BOT_TOKEN","6128579249:AAHjRFXEjddVAWuqfexUISBR58Hb_nL3xjk")
...
print(">> Bot aktivdi bot haqda məlumatı @ThisisYusif-dan ala bilərsən\n\nVersiya 1.7.5<<")
